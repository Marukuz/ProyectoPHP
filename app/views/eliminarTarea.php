...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="../controllers/filtroModificarTarea.php">Modificar tarea</a>
                    <a class="nav-link active" href="#">Eliminar tarea</a>
    ...
    <br>
    <h1 style="text-align: center;">Eliminar tarea</h1><br>
    <div id="formulario" >
        <form action="eliminarTareaID.php" method="post">
            ID Tarea: <br>
