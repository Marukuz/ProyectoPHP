...
<?php $__env->startSection('contenido'); ?>
    ...
    <div id="formulario" >
        <form method="post">
            ID Tarea: <br>
            <input type="text" class="form-control" name="id" value="<?php echo e($tarea['tarea_id']); ?>" disabled><br>
            ...
            Fecha creacion: <br>
            <input type="date" class="form-control" name="fechac" value="<?php echo e($tarea['fecha_creacion']); ?>"><br>
            ...
            <textarea class="form-control" name="anotacion_inicial" ><?php echo e($tarea['anotacion_inicio']); ?></textarea>

            Anotacion final: <br>
            <textarea class="form-control" name="anotacion_final" ><?php echo e($tarea['anotacion_final']); ?></textarea>
